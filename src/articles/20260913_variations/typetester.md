...
initTypeSpecimen: Winds of change!
urlbase: '/articles/20260913_variations/'
fontname: AD-MegaPearlsVF
variableFont: true
varAxes:
  - name: Weight
    axis: wght
...
## Typeface-Info
While this has a new name, it's me having a go at Grancirculos again. I wasn't happy with the weight and made it thinner, then thicker, then changed the round endings with square ones, then kept both. Variable fonts for the win.

I changed some curves and spacing along the way. A yes, it also has small-caps now in all weights. But something related to the original GranCirculos is still available at font-weight:400.
