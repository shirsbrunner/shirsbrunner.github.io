...
## A bit of Background
I am a digital designer mainly working on web applications, but also websites, apps, flyers, posters and a lot more. I like to look at and be inspired by other design disciplines – like print, type, fashion, architecture – and to create things during the rest of the day.

I believe that design has a big impact on peoples lives and that good design can make a difference, not only in looks but even more so in interaction. I like things to be open and freely accessible, but don't agree with the current content stealing done to train AI-Models. I prefer a "better" thing to a "prettier" one and I like small mindful touches, where a designer tries to add small things to "live" up a product or service. 
...
In the last 10 years, I've mainly been working at agencies consulting clients (sometimes over multiple years), including: 
- Swiss Post
