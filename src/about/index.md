...
## A bit of Background
I am a digital designer, working for [we are cube³](https://wearecube.ch), the UX-division of [Puzzle ITC](https://puzzle.ch). I also like to be inspired by other design disciplines – like print, type, fashion, architecture – and to create things during the rest of the day.
